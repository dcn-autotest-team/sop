...
| **后端与服务端** | [`library/backend/`](./library/backend/) | 1 | 标准生产实践 |
...
- **[BACKEND-001] [微信小程序 CloudBase + 云托管活动积分闭环](./library/backend/wechat-miniprogram-cloudbase-cloud-hosting-sop.md)** (1 次修撰)
  - **核心技术**：微信小程序、`wx.cloud.callContainer`、CloudBase 文档型数据库、CloudBase 云存储、Node.js 20+、Docker、云托管
  - **解决痛点**：项目标准化与避坑

### AI 与 Agent 开发 (`library/ai-agent/`)
- **[AI-AGENT-001] [跨端 AI 原生桌面悬浮助手与视觉感知架构标准实现 (Tauri + Win32 + Vision LLM)](./library/ai-agent/desktop-tauri-vision-copilot-sop.md)** (2 次修撰)
...
- **[AI-AGENT-002] [RAG 知识库检索与文档问答管道标准实现](./library/ai-agent/rag-knowledge-base-pipeline.md)** (1 次修撰)
  ...
  - **解决痛点**：项目标准化与避坑
- **[AI-AGENT-003] [工业级垂直领域多模态单证智能抽取与微服务调度架构 (FastAPI + Celery + Dynamic Few-Shot + Qwen/DeepSeek)](./library/ai-agent/cargo-document-multimodal-extraction-sop.md)** (1 次修撰)
